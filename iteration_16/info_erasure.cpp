...
const int number_of_trajectories=2000;
// const int number_of_trajectories=100000;
const int number_of_trajectories_histogram=number_of_trajectories;

//size- and time parameters (fixed)
const double trajectory_time=100;
...
// const int number_of_report_steps=10;
...
const int number_of_inputs=1; // DP change the inputs for just time
...
//seed RN generator
srand48(seed); // setting the start of random number setting
...
// returns a normal univariate value  with mean 0 and std dev equals sigma 
double gauss_rv(double sigma){
...
//inputs
inputs[0]=tau;
// inputs[1]=position; //DP change here for input parameters
